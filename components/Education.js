            ...
            <div className="mt-12" data-name="education-section">
                ...
                <div className="space-y-8">
                    <div data-name="education-item">
                        ...
                        <div className="text-gray-600">Info Institute Of Engineering</div>
                    </div>
                    <div data-name="education-item">
                        ...
                        <div className="text-gray-600">CIT sandwich Polytechnic College</div>
                    </div>
                    <div data-name="education-item">
                        <div className="text-green-600">2017-2018</div>
                        <div className="font-bold text-white/40">SSLC</div>
                        <div className="text-gray-600">Arasur Governtment Higher Secondary School</div>
                    </div>
                </div>
            </div>
        );

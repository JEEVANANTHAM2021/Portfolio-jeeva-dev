function Contact() {
    try {
        ...
        return (
            <div className="mt-16 mb-16 shadow-lg" data-name="contact-section">
                        ...
                        <div className="space-y-4">
                            {messages.map((msg) => (
                                <div key={msg.id} className="relative group" data-name="message-item">
                                    <div className="absolute -inset-1 bg-gradient-to-r from-pink-100 via-violet-100 to-blue-100 rounded-xl blur opacity-10 group-hover:opacity-25 transition duration-500"></div>
